...
export interface IManagerV2Interface extends utils.Interface {
  contractName: "IManagerV2";
  functions: {
...
export interface IManagerV2 extends BaseContract {
  contractName: "IManagerV2";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IManagerV2Interface;
  ...
  functions: {
    ...
    getLatestInfoAll(
      token: IManager.TokenStruct,
      overrides?: CallOverrides
    ): Promise<[string[], string[]] & { creators: string[]; uris: string[] }>;
