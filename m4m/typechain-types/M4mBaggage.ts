...
export interface M4mBaggageInterface extends utils.Interface {
  contractName: "M4mBaggage";
  functions: {
...
export interface M4mBaggage extends BaseContract {
  contractName: "M4mBaggage";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: M4mBaggageInterface;
