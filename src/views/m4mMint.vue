...
<script>
import {isApprovalForAll, setApprovalForAll, handleGameEnd, handleUnlockComponents, handleLockComponents} from '@m4m/mint';
...
export default {
  ...
  methods: {
    ...
    handleLockNFT(){
      ...
      handleLockComponents(this.chainStore.provider, this.mint.targetContract, this.mint.m4mTokenId.toString(), this.mint.gameId, [], []).then(res=>{
    ...
    handleUnlockNFT(){
      ...
      handleUnlockComponents(this.mint.targetContract, this.mint.m4mTokenId.toString(), this.mint.nonce, [], this.mint.operatorSig, this.mint.gameSignerSig).then(res=>{
    ...
    handleMintResult(){
      ...
      handleGameEnd(this.mint.targetContract, this.mint.m4mTokenId.toString(), this.mint.nonce, this.mint.params, this.mint.operatorSig, this.mint.gameSignerSig).then(res=>{
