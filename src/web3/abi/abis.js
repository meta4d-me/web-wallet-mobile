export const ABI = [
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'string', name: '_group', type: 'string' },
      { internalType: 'uint256', name: '_upper', type: 'uint256' },
      { internalType: 'bool', name: 'isBusd', type: 'bool' },
    ],
    name: 'buy',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  },
  {
    ...
    outputs: [{
      ...
      internalType: 'struct WgMarket.Record[]',
      name: '',
      type: 'tuple[]',
    }],
    stateMutability: 'view',
