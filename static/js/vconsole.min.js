      ...
      return function(e) {
        ...
        function(e, t, o) {
          ...
          function g(e, t) {
            ...
            if (t.singleton) {
              ...
              var n = o.css,
                r = o.sourceMap,
                i = void 0 === t.convertToAbsoluteUrls && r; (t.convertToAbsoluteUrls || i) && (n = u(n));
            ...
            var b = 1e3,
              h = function(e) {
                function t() {
                  ...
                  return (o = f(this, (e = v(t)).call.apply(e, [this].concat(r)))).tplTabbox = "",
                  ...
                  },
                  {
                    ...
                    value: function(e) {
                      ...
                      if (t.length || e.content) {
                        ...
                        if (n.isString(t[0])) {
                          var c = t[0].match(i);
                          null !== c && c.length > 0 && (l = c[1].toLowerCase())
                        }
                        if (l ? o = l == this.id: 0 == this.allowUnformattedLog && (o = !1), o) if (e.date || (e.date = +new Date), this.isReady) {
                          if (n.isString(t[0]) && (t[0] = t[0].replace(i, ""), "" === t[0] && t.shift()), !e.meta) {
                            var s = n.getDate(e.date);
                            e.meta = s.hour + ":" + s.minute + ":" + s.second
                          }
                          for (var u = r.
                          default.render(a.
                            default, {
                          ...
                          default.one(".vc-item-content", u), v = 0; v < t.length; v++) {
                            var p = void 0;
                            try {
                              if ("" === t[v]) continue;
                              p = n.isFunction(t[v]) ? "<span> " + t[v].toString() + "</span>": n.isObject(t[v]) || n.isArray(t[v]) ? this.getFoldedLine(t[v]) : "<span> " + n.htmlEncode(t[v]).replace(/\n/g, "<br/>") + "</span>"
                            } catch(e) {
                              p = "<span> [" + d(t[v]) + "]</span>"
                            }
                            p && ("string" == typeof p ? f.insertAdjacentHTML("beforeend", p) : f.insertAdjacentElement("beforeend", p))
                          }
                          n.isObject(e.content) && f.insertAdjacentElement("beforeend", e.content),
                            r.
                            default.one(".vc-log", this.$tabbox).insertAdjacentElement("beforeend", u),
                            this.logNumber++,
                            this.limitMaxLogs(),
                        ...
                        function(t) {
                          ...
                          return setTimeout(function() {
                            if (0 == i.children.length && e) {
                              ...
                              if (n.isObject(e)) {
                                var h, m = e.__proto__;
                                h = n.isObject(m) ? o.getFoldedLine(m, r.
                                default.render(c.
                                    default, {
                                    key: "__proto__",
                                    keyType: "private",
              ...
              _ = function() {
                function e(t) {
                  ...
                  default.one(y)) console.debug("vConsole is already exists.");
                    ...
                    if (void 0 !== document)"complete" == document.readyState ? c() : i.
                    default.bind(window, "load", c);
        ...
        function(e, t, o) {
          ...
          void 0 === (i = "function" == typeof(n = function(o, n, r, i) {
            ...
            function d(e, t, o) {
              return (d = "undefined" != typeof Reflect && Reflect.get ? Reflect.get: function(e, t, o) {
                var n = function(e, t) {
            ...
            var v = function(e) {
              function t() {
                ...
                return (o = s(this, (e = u(t)).call.apply(e, [this].concat(r)))).tplTabbox = i.
                  default,
              ...
              (n = [{
              ...
              },
                {
                  ...
                  value: function() {
                    ...
                    t = "Unknown",
                      l && l[1] ? (t = l[1], a += ", WeChat " + t, console.info("[system]", "System:", a)) : console.info("[system]", "System:", a),
                      t = "Unknown",
                      t = "https:" == location.protocol ? "HTTPS": "http:" == location.protocol ? "HTTP": location.protocol.replace(":", ""),
                      a = t;
                    var c = e.toLowerCase().match(/ nettype\/([^ ]+)/g);
                    t = "Unknown",
                      c && c[0] ? (c = c[0].split("/"), t = c[1], a += ", " + t, console.info("[system]", "Network:", a)) : console.info("[system]", "Protocol:", a),
          ...
          void 0 === (i = "function" == typeof(n = function(o, n, r, i, a, l, c) {
            ...
            var b = function(e) {
              function t() {
                ...
                return (o = f(this, (e = v(t)).call.apply(e, [this].concat(i)))).$tabbox = n.
                default.render(a.
                  default, {}),
                  o.$header = null,
                  o.reqList = {},
                    ...
                    if (e) {
                      ...
                      t._open = o,
                        ...
                        window.XMLHttpRequest.prototype.send = function() {
                          ...
                          if ("POST" == i.method) if (r.isString(o)) {
                            var v = o.split("&");
                            i.postData = {};
                            var p = !0,
                              b = !1,
                              h = void 0;
                            try {
                              for (var m, g = v[Symbol.iterator](); ! (p = (m = g.next()).done); p = !0) {
                                var y = m.value;
                                y = y.split("="),
                                  i.postData[y[0]] = y[1]
                              }
          ...
          void 0 === (i = "function" == typeof(n = function(o, n, r, i, a, l) {
            ...
            var p = function(e) {
              function t() {
                ...
                return (o = u(this, (e = f(t)).call.apply(e, [this].concat(i)))).$tabbox = l.
                default.render(r.
                  default, {}),
                  o.currentType = "",
                  o.typeNameMap = {
